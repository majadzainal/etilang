      ...
      <div class="card p-0">
            <div class="card-header">
                  <div class="row">
                        ...
                        <div class="col-4 text-right">
                              <button class="btn btn-sm text-secondary" data-toggle="modal" data-target="#deleteModal">Batal</button>
                        </div>
                  </div>
            </div>
            <div class="card-body p-4">
                  <form method="POST" 
                        ...
                        action="{{ url('dashboard/pelanggaran/tilangpelanggar')}}">
                        @csrf
                        @method('post')
                        <div class="row">
                              ...
                              @if($tilang)
                                    ...
                                    <div class="col-md-12 form-group">
                                          <input type="text" hidden="hidden" name="nik" value="{{ $nik }}" />
                                          <button type="submit" {{ $tilang ? '' : 'disabled' }} class="form-control {{ $tilang ? 'btn-danger' : 'btn-secondary' }} btn-lg"><h3>TILANG SEKARANG !</h3></button>
                                    </div>
                              @else
                              <div class="col-md-12 form-group">
                                    <a href = "{{ url('dashboard/pelanggaran') }}" ><button type="button" class="form-control btn-primary btn-lg"><h3>SELESAI !</h3></button></a>
                              </div>                                    
                              @endif
                        </div>
                  </form>
